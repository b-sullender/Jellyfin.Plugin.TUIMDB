...
{
    /// <summary>
    /// Represents a primary poster of a movie returned by the TUIMDB API.
    /// </summary>
    public class TuimdbMoviePoster
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the order of the poster (for multi-poster movies, usually 1 for the primary).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether the poster is locked (cannot be edited).
        /// </summary>
