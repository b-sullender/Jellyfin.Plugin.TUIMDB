...
/// </summary>
public class MovieCollectionProvider : ICustomMetadataProvider<Movie>, IHasOrder
{
    private readonly ICollectionManager _collectionManager;
    private readonly ILibraryManager _libraryManager;
    private readonly ILogger<MovieCollectionProvider> _logger;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MovieCollectionProvider"/> class.
    /// </summary>
    /// <param name="collectionManager">The collection manager.</param>
    /// <param name="libraryManager">The library manager.</param>
    /// <param name="logger">The logger.</param>
    public MovieCollectionProvider(
        ICollectionManager collectionManager,
        ILibraryManager libraryManager,
        ILogger<MovieCollectionProvider> logger)
    {
        _collectionManager = collectionManager;
        _libraryManager = libraryManager;
        _logger = logger;
        _logger.LogInformation("TUIMDB MovieCollectionProvider constructed");
    }
    ...
    {
        _logger.LogDebug(
            "TUIMDB MovieCollectionProvider item dump: {ItemJson}",
        ...
        // Get collection IDs from the item (set by MovieProvider).
        ...
        {
            _logger.LogError("TUIMDB MovieCollectionProvider: Plugin configuration is null");
            return ItemUpdateType.None;
        }
